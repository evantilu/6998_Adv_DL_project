...
def prep_data(
    ...
    #                      'Day_Of_Week', 'Month_Of_Year', 'Quarter_Of_Year']]
    train_df = train_df[['demand_score', 'hotness_score', 'median_listing_price', 'supply_score',
                         'Day_Of_Week', 'Month_Of_Year', 'Quarter_Of_Year']]
    test_df = test_df[['demand_score', 'hotness_score', 'median_listing_price', 'supply_score',
                         'Day_Of_Week', 'Month_Of_Year', 'Quarter_Of_Year']]
